  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col bg-white font-modern mx-[10%] mb-[4.445vh]">
        ...
        <div className="flex flex-col bg-contrast-gray mt-8 hover:shadow-light p-5">
          <h3 className="text-2xl">Tips for Users</h3>
          <ul className="mt-2 text-lg">
            <li className="mb-2">&#x2022; For a company’s own description of its ESG practices, click on the company SEC filings link on the company profile page and select the company’s most recent proxy statement for its annual meeting where you will find disclosures about the company’s governance matters.</li>
            <li className="mb-1.5">&#x2022; Additionally, click on the link to the company’s own website on the company profile page and navigate to its investor relations page. On the investor relations pages, you will find a significant amount of additional information about the company, including, in some cases, its own sustainability reports.</li>
        ...
        <div className="flex flex-col mt-10 bg-contrast-gray hover:shadow-light p-5">
          <h3 className="text-2xl">The Design</h3>
          <div className="flex flex-col text-lg mt-2">
            <p>This website was written in TypeScript using MongoDB, ExpressJS, React, and NodeJS. It was styled with TailwindCSS.</p>
