...
const NavBar: React.FC = () => {
  return (
    <div className="relative flex flex-row items-center justify-evenly bg-main-red border-b-2 border-black p-5 font-modern text-black font-extrabold text-xl">
      <div>
      ...
      <div>
        <a className="flex flex-row" href={Github_URL}>
